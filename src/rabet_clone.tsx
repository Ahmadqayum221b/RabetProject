      ...
      <div className="w-full max-w-[480px] min-h-screen bg-gradient-to-br from-[#642aff] via-purple-950 to-[#a74e4e] text-white font-sans relative shadow-[0_0_100px_rgba(0,0,0,0.8)] flex flex-col">
        ...
        <div className={`fixed inset-0 z-[2000] flex justify-center transition-all duration-300 ${showSidebar ? 'visible' : 'invisible'}`}>
          ...
          <div className={`absolute left-1/2 -translate-x-1/2 w-full max-w-[480px] h-full pointer-events-none`}>
            <div className={`absolute left-0 top-0 bottom-0 w-72 bg-gradient-to-b from-indigo-950 to-purple-950 shadow-2xl transition-transform duration-300 pointer-events-auto ${showSidebar ? 'translate-x-0' : '-translate-x-full'}`}>
              <div className="p-6">
                <button
                  onClick={() => setShowSidebar(false)}
          ...
          <>
            ...
            >
              {[
                ...
                <div
                  key={index}
                  className={`relative flex items-center justify-between pl-12 pr-4 py-2 
                  bg-gradient-to-r ${jackpot.color}
                  rounded-xl shadow-lg w-[230px]
          ...
          <div className="px-4 py-6 pb-32">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex flex-col h-60 xs:h-72 rounded-[2rem] overflow-hidden shadow-2xl bg-white mb-6">
                  {/* 80% Image Section */}
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-gradient-to-t from-indigo-950 via-purple-950/95 to-transparent backdrop-blur-lg border-t border-purple-500/30 z-[1000]">
